    ...
    <div className="flex flex-col flex-1 items-center gap-4 justify-center bg-zinc-100 px-4">
      ...
      <div className="bg-white rounded-4xl shadow-md shadow-zinc-200 lg:w-[60%] w-full  h-auto py-4 px-4 flex items-center gap-2 justify-between">
        <div className="flex items-center gap-2 relative">
          <div className="rounded-2xl group flex items-center gap-1 hover:bg-black text-xs text-white font-semibold p-2 border border-neutral-700 cursor-pointer ease-in-out duration-300 ">
            <Camera />
        ...
        <textarea ref={size} placeholder="Ask AI about these ingredients..." className=" w-full p-1 text-xs text-gray-500 resize-none outline-0 field-sizing-content" ></textarea>
